	...
	<div class="body-main">
		<div class="top-row">
			<div class="task-mg-row">
				<h2 class="my-1">Add Picture</h2>
				
				<div class="right-sec">
					<ul>
						
						<li>
							<a href="{{route('picture.list')}}" class="link">Back</a>
						</li>
					</ul>
				</div>
			</div>
		...
		<form action="{{route('insert.pic')}}" method="post" id="frm" enctype="multipart/form-data">
			@csrf
			<div class="top-row">
