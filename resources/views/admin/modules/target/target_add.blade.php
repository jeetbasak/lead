 ...
 @include('admin.include.errors')
  <div class="container-fluid">
                    <div class="body-main">
                       ...
                       <form action="{{route('admin.target.insert')}}" method="post" id="frm">
                        @csrf
                        <div class="top-row">
                            <div class="flx-row my-3">
                                ...
                                <div class="flx-col">
                                    ...
                                    <input class="form-control" placeholder="Enter salary" type="text" name="salary">
                                </div>
                            </div>
