...
@section('title')
<title>Admin | Add Tutorial</title>
@endsection
@section('left_part')
 ...
 @include('admin.include.errors')
  <div class="container-fluid">
                    <div class="body-main">
                       ...
                       <form action="{{route('tutorial.added')}}" method="post" id="frm">
                        @csrf
                        <div class="top-row">
                            ...
                            <div class="flx-row my-3">
                                <div class="flx-col">
                                    ...
                                    <input class="form-control" placeholder="From target" type="text" name="title" id="title">
                                </div>
                            </div>
                             ...
                             <div class="row">
                                      ...
                                      <label for="CategoryName">Video</label>
                                        ...
                                        <textarea id="mytextarea2" style="width: 100%;height: 350px" name="video" id="video" ></textarea>
