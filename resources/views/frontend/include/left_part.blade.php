...
<div class="border-end bg-deepblue" id="sidebar-wrapper">
	...
	<div class="list-group list-group-flush">
		...
		<a class="{{request()->segment(2)=='notifications'?'list-group-item-action left-nav custom_active':'list-group-item-action left-nav'}}" href=""><i class="fa fa-bell-n"></i><span>Notifications</span></a>
